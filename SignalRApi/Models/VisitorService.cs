...
namespace SignalRApi.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorCharts()
        {
            ...
            {
                command.CommandText = "Select * from crosstab( 'select VisitDate,City,CityVisitCount from Visitors order by 1,2') As ct" +
                    "(VisitDate date,City1 int,City2 int, City3 int,City4 int,City5 int);";
